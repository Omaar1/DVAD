...
#
# SVR1's ms-Mcs-AdmPwd value is planted later by configure-machine-attacks.ps1,
# once SVR1 has joined the domain (it does not exist yet at this point).
#
...
$lapsMsi = "C:\vagrant\sharedscripts\ad\LAPS\LAPS.x64.msi"
